...
public interface WeatherQueryEndpoint {
	 ...
	 * information about how the number of datapoints currently held in memory, the
	 * frequency of requests for each IATA code and the frequency of requests for
	 * each radius.
	 *
	...
	/**
	 * Retrieve the most up to date atmospheric information from the given airport
	 * and other airports in the given radius.
	 *
	 * @param iata
	 ...
	 *
	 * @return an HTTP Response and a list of {@link AtmosphericInformation} from
	 *         the requested airport and airports in the given radius
	 */
	@GET
